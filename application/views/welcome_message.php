			...
			<div class="gallery-agileinfo">
				<div class="col-sm-4 col-xs-6 w3gallery-grids">
					<a href="<?php echo base_url('/assets/images/g1.jpg');?>" class="imghvr-hinge-right figure">
						<img src="<?php echo base_url('/assets/images/g1.jpg');?>" alt="" title="Travel Adventure Image"/> 
				...
				<div class="col-sm-4 col-xs-6 w3gallery-grids">
					<a href="<?php echo base_url('/assets/images/g2.jpg');?>" class="imghvr-hinge-right figure">
						<img src="<?php echo base_url('/assets/images/g2.jpg');?>" alt="" title="Travel Adventure Image"/> 
						<div class="agile-figcaption">
				...
				<div class="col-sm-4 col-xs-6 w3gallery-grids">
					<a href="<?php echo base_url('/assets/images/g3.jpg');?>" class="imghvr-hinge-right figure">
						<img src="<?php echo base_url('/assets/images/g3.jpg');?>" alt="" title="Travel Adventure Image"/> 
						<div class="agile-figcaption">
				...
				<div class="col-sm-4 col-xs-6 w3gallery-grids">
					<a href="<?php echo base_url('/assets/images/g4.jpg');?>" class="imghvr-hinge-right figure">
						<img src="<?php echo base_url('/assets/images/g4.jpg');?>" alt="" title="Travel Adventure Image"/> 
						<div class="agile-figcaption">
				...
				<div class="col-sm-4 col-xs-6 w3gallery-grids">
					<a href="<?php echo base_url('/assets/images/g5.jpg');?>" class="imghvr-hinge-right figure">
						<img src="<?php echo base_url('/assets/images/g5.jpg');?>" alt="" title="Travel Adventure Image"/> 
						<div class="agile-figcaption">
						  <h4>Sky Dive</h4>
						  <p>Phasellus elementum ullamcorper urna, eu rhoncus.</p>
						</div>
				...
				<div class="col-sm-4 col-xs-6 w3gallery-grids">
					<a href="<?php echo base_url('/assets/images/g6.jpg');?>" class="imghvr-hinge-right figure">
						<img src="<?php echo base_url('/assets/images/g6.jpg');?>" alt="" title="Travel Adventure Image"/> 
						<div class="agile-figcaption">
						...
						<li>
							<div class="w3l-info1">
								...
								<div class="testimonials-grid-2">
									...
									Quisque ut risus eget libero finibus facilisis. Phasellus tempus hendrerit sem ut iaculis.
									Sed sit amet augue sit amet mauris gravida interdum. Donec vulputate tempus sem eget tempus hendrerit sem ut.</p>
									<h4>Victoria</h4>
...
<!-- blog -->
	<div class="blog" id="blog">
		<div class="container">
			...
			<h3 class="w3ls-title">Our Blog</h3>
			<div class="agile_inner_w3ls-grids">
				...
				<div class="col-sm-6 w3-agile-post-grids">
					<div class="col-md-6 w3-agile-post-img w3-agile-post-img11">
						<a href="#" data-toggle="modal" data-target="#myModal"> 
						</a>
					</div>
					<div class="col-md-6 w3-agile-post-info">
						<h4><a href="#" data-toggle="modal" data-target="#myModal">Quisque a rhoncus</a></h4>
						<p>Suspendisse in nisl at ipsum molestie dignissim. Pellentesque est nisi, blandit eget aliquam sed, 
						Quisque ut risus eget libero finibus facilisis. Phasellus tempus hendrerit sem ut iaculis. consequat nec risus.</p>
					</div>
					<a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-search-plus iconsearch" aria-hidden="true"></i></a>
				</div>
				<div class="col-sm-6 w3-agile-post-grids">
					<div class="col-md-6 w3-agile-post-img w3-agile-post-img21">
						<a href="#" data-toggle="modal" data-target="#myModal"> 
						</a>
					</div>
					<div class=" col-md-6 w3-agile-post-info">
